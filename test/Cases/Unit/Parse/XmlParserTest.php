...
use XMLReader;
	...
	public function testEachChildOf() {
		$xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
					<rootNode>
						<item><b>15</b><d>25</d></item>
						<item><b>16</b><c>26</c></item>
						<item><b>17</b><d>27</d></item>
						<item2><b>18</b><d>28</d></item2>
					</rootNode>";
		...
		$i = 0;
		$this->assertSame($parser, $parser->eachChildOf('rootNode.item', function (XmlParser $parser) use (&$i) {
			switch ($i++) {
				case 0:
				case 2:
				case 4:
					$this->assertSame('b', $parser->elName());
					break;

				case 1:
				case 5:
					$this->assertSame('d', $parser->elName());
					break;
					
				case 3:
					$this->assertSame('c', $parser->elName());
					break;
	...
	public function testEachChildOf_currentNode() {
		$xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>
					<rootNode>
						<item><b>15</b><d>25</d></item>
						<item><b>16</b><c>26</c></item>
		...
		$parser->root(function(XmlParser $parser) use (&$i) {
			$parser->each('item', function(XmlParser $parser) use (&$i) {

				$this->assertSame($parser, $parser->eachChildOf('', function (XmlParser $parser) use (&$i) {
